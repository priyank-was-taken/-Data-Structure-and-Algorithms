...
# arr2 = array('d', [2.1, 3.1, 4.1, 5.1, 6.1])
# print(arr1)
# #
...
# row = 1
# col = 1
# accesselement(array, row, col)
#
# def treverse2DArray(array, n):
...
#
#
# print(treverse2DArray(array, 14))
# #
# #
# twoDArray = np.array([[11, 15, 10, 6], [10, 14, 11, 5], [12, 17, 12, 8], [15, 18, 14, 9]])
# print(twoDArray)
# new2dArray = np.delete(twoDArray, 1, axis=0)
# print(new2dArray)
# #
# total = 0
# count = 0
...
# print(sum)
# #
# numdays = int(input("no. of days: "))
# total = 0
# temp = []
# for i in range(1, numdays + 1):
#     nextday = int(input("Day" + str(i) + "'s high temprature: "))
#     temp.append(nextday)
#     total += nextday
...
# for i in temp:
#     if i > average:
#         print(str(temp.index(i)+1)+"'s day")
#         above += 1
# print(str(above) + ' days temp is above average')
# #
#
# arr = [1, 2, 3, 4, 5, 6, 8, 9]
#
...
# #
# #
# arr = np.array([1, 20, 13, 24, 52, 61, 17, 38, 9, 10, 31, 22, 13, 14, 85, 46, 17, 98, 19, 2])
#
#
# def product(array):
#     max_product = 0
...
#         return False
#
#     if not cb(arr[0]):   #if cb(arr[0]) == False:
#         return someRecursive(arr[1:], cb)
#     return True
#
#
# lst = [2, 4, 6, 8]
# print(someRecursive(lst, isOdd))
# #
# lst1 = [1, 2, 3, 4, 5, 6]
# #
# def remove(arr):
...
#             if lst[i][j] == lst[0][0]:
#                 sum += lst[i][j]
#             elif lst[i][j] == lst[1][1]:
#                 sum += lst[i][j]
#             elif lst[i][j] == lst[2][2]:
#                 sum += lst[i][j]
#     return sum
#
# print(remove(myList2D))
# #
# def remove(lst):
#     sum = lst[0][0] + lst[1][1] + lst[2][2]
#     print(sum)
#
# remove(myList2D)
# #
...
#                 elements.append(str(myList[i])+'+'+str(myList[j]))
#     return elements
#
#
# print(pairSum(a, 9))
...
#
#     sorting = sorted(key_value.items())
#     print(sorting)
#
# dicto()
# #
...
#     key_value['suraj'] = '32'
#
#     print('original dict', key_value)
#     new_dict = {}
#     keys = sorted(key_value)
#     print('sorted keys', keys)
#     for i in range(len(keys)):
#         new_dict[keys[i]] = key_value[keys[i]]
#     print('sorted dict', new_dict)
#
#
# dicto()
#
...
#     return len(nums)
#
# print(vnhussan([0,0,1,1,1,2,2,3,3,4]))
# #
# #
...
# client.connect(('49.36.237.129', 7976))  # connecting client to server
#
#
# def receive():
...
# write_thread.start()
#
# lst = [['aqua', 4], ['tini', 6], ['gwen', 9], ['stuert', 9]]
# lst2 = []
